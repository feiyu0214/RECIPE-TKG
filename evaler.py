...
class Evaler:
    def __init__(self, topk, tests, test_ans, 
        ...
        if args.apply_semantic_filter:
            ...
            self.candidate_tracker = defaultdict(dict)  # For sequential candidate selection
            self.current_sample_predictions = set()  # Track all predictions for current sample
